...
exports.startHttp = async (server) => {

    const portServer = process.env.PORT || 7405;
    const app = express();
    ...
    app.listen(portServer, () => {
        console.log("Success running server " + portServer)
    })
...
exports.wrapText = (context, text, x, y, maxWidth, lineHeightRatio, fromBottom, fontSize, fontFamily) => {
	if (!text) {
		return;
	}
